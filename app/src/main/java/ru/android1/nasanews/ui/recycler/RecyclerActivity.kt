package ru.android1.nasanews.ui.recycler
...
import kotlinx.android.synthetic.main.activity_recycler_tasks.view.*
import kotlinx.android.synthetic.main.activity_recycler_tips.view.*
...
class RecyclerActivityAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): BaseViewHolder {
        ...
        return when (viewType) {
            TYPE_TASKS -> EarthViewHolder(
                inflater.inflate(R.layout.activity_recycler_tasks, parent, false) as View
            )
            TYPE_TIPS ->
                MarsViewHolder(
                    inflater.inflate(R.layout.activity_recycler_tips, parent, false) as View
                )
            else -> HeaderViewHolder(
                inflater.inflate(R.layout.activity_recycler_header, parent, false) as View
            )
        }
    }
    ...
    override fun getItemViewType(position: Int): Int {
        return when {
            ...
            data[position].first.someDescription.isNullOrBlank() -> TYPE_TIPS
            else -> TYPE_TASKS
        }
    }
...
//                notifyItemChanged(1, Pair(Data("", ""), false))
    ...
    companion object {
        private const val TYPE_TASKS = 0
        private const val TYPE_TIPS = 1
